			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><span>1</span></li>
						<li><span>2</span></li>
						<li><a href="../masakans" class=""><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="../masakans"class=""><i class="lnr lnr-smile"></i> <span>Masakan</span></a></li>
						<li><a href="../orders" class="active"><i class="lnr lnr-file-add"></i> <span>Order</span></a></li>
						...
						<li><a href="../laporans" class=""><i class="lnr lnr-laptop-phone"></i> <span>Laporan</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
